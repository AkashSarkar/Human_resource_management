$(function () {
    ...
    $(document).ready(function () {
        ...
        dataTable = $('#listDataTable').DataTable({
            ...
            "ajax": {
                'type': 'POST',
                'url': $("#profession_datatable").val(),
                'data': data,
            },
            "columns": [
                {"data": "id", "sortable": false, "orderable": false, "searchable": false},
                {"data": "profession", "sortable": false, "orderable": false},
                {"data": "id", "sortable": false, "orderable": false, "searchable": false},
            ],
            "columnDefs": [
                {
        ...
        $('#listDataTable').on('click', 'tr', function(){
            ...
            id=oData.id;
            $("#e_profession").val(oData.profession);
        });
        //delete
