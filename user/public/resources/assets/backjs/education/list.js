$(function () {
    ...
    $(document).ready(function () {
        ...
        dataTable = $('#listDataTable').DataTable({
            ...
            "ajax": {
                'type': 'POST',
                'url': $("#education_datatable").val(),
                'data': data,
            },
            "columns": [
                {"data": "id", "sortable": false, "orderable": false, "searchable": false},
                {"data": "education", "sortable": false, "orderable": false},
                {"data": "id", "sortable": false, "orderable": false, "searchable": false},
            ],
            "columnDefs": [
                {
        ...
        $('#listDataTable').on('click', 'tr', function(){
            ...
            id=oData.id;
            $("#e_education").val(oData.education);
        });
        //delete
