$(function () {
    ...
    $(document).ready(function () {
        ...
        dataTable = $('#listDataTable').DataTable({
            ...
            "ajax": {
                'type': 'POST',
                'url': $("#industry_datatable").val(),
                'data': data,
            },
            "columns": [
                {"data": "id", "sortable": false, "orderable": false, "searchable": false},
                {"data": "industry", "sortable": false, "orderable": false},
                {"data": "id", "sortable": false, "orderable": false, "searchable": false},
            ],
            "columnDefs": [
                {
