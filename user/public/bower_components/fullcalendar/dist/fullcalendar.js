...
var GlobalEmitter = /** @class */ (function () {
    ...
    GlobalEmitter.prototype.bind = function () {
        ...
        // TODO: investigate performance because this is a globals handler
...
function datepickerLocale(localeCode, dpLocaleCode, dpOptions) {
    ...
    if (jqDatePicker) {
        ...
        // Set as Datepicker's globals defaults.
        jqDatePicker.setDefaults(dpOptions);
    }
}
exports.datepickerLocale = datepickerLocale;
// Sets FullCalendar-specific translations. Will set the locales as the globals default.
...
var InteractiveDateComponent = /** @class */ (function (_super) {
    ...
    // Sets the container element that the view should render inside of, does globals DOM-related initializations,
...
var MAYBE_REGEXP = new RegExp(MAYBE_MARKER + '([^' + MAYBE_MARKER + ']*)' + MAYBE_MARKER, 'g'); // must be globals
/*
...
function isOverlapEventInstancesAllowed(overlapEventFootprints, subjectEventInstance) {
    ...
    for (i = 0; i < overlapEventFootprints.length; i++) {
        ...
        // don't need to pass in calendar, because don't want to consider globals eventOverlap property,
