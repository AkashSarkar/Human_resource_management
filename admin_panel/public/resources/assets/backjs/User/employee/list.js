$(function () {
    ...
    $(document).ready(function () {
        ...
        $('#listDataTable').on('click', 'tr', function(){
           ...
           {
               id=oData.id;
               $("#e_name").val(oData.name);
               $("#e_email").val(oData.email);
               $("#e_f_name").val(oData.f_name);
               $("#e_phone").val(oData.phone);
               $("#e_dob").val(oData.dob);
               $("#e_p_address").val(oData.p_address);
               $("#e_l_address").val(oData.l_address);
               console.log(oData);
           }
        });
        //delete
