$(function () {
    ...
    $(document).ready(function () {
        ...
        dataTable = $('#listDataTable').DataTable({
            ...
            "ajax": {
                'type': 'POST',
                'url': $("#company_datatable").val(),
                'data': data,
            },
            "columns": [
                {"data": "id", "sortable": false, "orderable": false, "searchable": false},
                {"data": "company", "sortable": false, "orderable": false},
                {"data": "id", "sortable": false, "orderable": false, "searchable": false},
            ],
            "columnDefs": [
                {
